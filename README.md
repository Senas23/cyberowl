...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |[<a href="https://vigilance.fr/vulnerability/SQLite-integer-overflow-via-FTS5-Extension-48141" class="noirorange"><b>SQLite</b>: integer overflow via FTS5 Extension</a>](https://vigilance.fr/vulnerability/SQLite-integer-overflow-via-FTS5-Extension-48141)|An attacker can trigger an integer overflow of SQLite, via FTS5 Extension, in order to trigger a denial of service, and possibly to run code...|Visit link for details|
