...
# CyberOwl
 ...
 > Last Updated 07/12/2025 09:25:20 UTC
...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |Title|Description|Date|
 |---|---|---|
 |[<a href="https://vigilance.fr/vulnerability/Python-Core-use-after-free-via-xml-parsers-expat-48398" class="noirorange"><b>Python Core</b>: use after free via xml.parsers.expat</a>](https://vigilance.fr/vulnerability/Python-Core-use-after-free-via-xml-parsers-expat-48398)|An attacker can force the reuse of a freed memory area of Python Core, via xml.parsers.expat, in order to trigger a denial of service, and possibly to run code...|Visit link for details|
