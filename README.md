...
# CyberOwl
 ...
 > Last Updated 13/12/2025 09:25:53 UTC
...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |[<a href="https://vigilance.fr/vulnerability/Intel-RealSense-Dynamic-Calibrator-privilege-escalation-via-Uncontrolled-Search-Path-48436" class="noirorange"><b>Intel RealSense Dynamic Calibrator</b>: privilege escalation via Uncontrolled Search Path</a>](https://vigilance.fr/vulnerability/Intel-RealSense-Dynamic-Calibrator-privilege-escalation-via-Uncontrolled-Search-Path-48436)|An attacker can bypass restrictions of Intel RealSense Dynamic Calibrator, via Uncontrolled Search Path, in order to escalate his privileges...|Visit link for details|
 |[<a href="https://vigilance.fr/vulnerability/python-socketio-code-execution-via-Pickle-Deserialization-48435" class="noirorange"><b>python-socketio</b>: code execution via Pickle Deserialization</a>](https://vigilance.fr/vulnerability/python-socketio-code-execution-via-Pickle-Deserialization-48435)|An attacker can use a vulnerability of python-socketio, via Pickle Deserialization, in order to run code...|Visit link for details|
 |[<a href="https://vigilance.fr/vulnerability/CRI-O-overload-via-securityContext-runAsUser-48434" class="noirorange"><b>CRI-O</b>: overload via securityContext.<wbr>runAsUser</wbr></a>](https://vigilance.fr/vulnerability/CRI-O-overload-via-securityContext-runAsUser-48434)|An attacker can trigger an overload of CRI-O, via securityContext.|Visit link for details|
 ...
 |[<a href="https://vigilance.fr/vulnerability/Joomla-Core-file-upload-via-Media-Manager-46569" class="noirorange"><b>Joomla Core</b>: file upload via Media Manager</a>](https://vigilance.fr/vulnerability/Joomla-Core-file-upload-via-Media-Manager-46569)|An attacker can upload a malicious file on Joomla Core, via Media Manager, in order for example to upload a Trojan...|Visit link for details|
