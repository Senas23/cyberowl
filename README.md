...
# CyberOwl
 ...
 > Last Updated 25/04/2023 21:18:15 UTC
...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |[<a href="https://vigilance.fr/vulnerability/Linux-kernel-NULL-pointer-dereference-via-hci-uart-tty-ioctl-41125" class="noirorange"><b>Linux kernel</b>: NULL pointer dereference via <wbr>hci_uart_tty_ioctl()</wbr></a>](https://vigilance.fr/vulnerability/Linux-kernel-NULL-pointer-dereference-via-hci-uart-tty-ioctl-41125)|An attacker can force a NULL pointer to be dereferenced on the Linux kernel, via |Visit link for details|
 ...
 |[<a href="https://vigilance.fr/vulnerability/Linux-kernel-NULL-pointer-dereference-via-vidtv-mux-stop-thread-41123" class="noirorange"><b>Linux kernel</b>: NULL pointer dereference via <wbr>vidtv_mux_stop_threa<wbr>d()</wbr></wbr></a>](https://vigilance.fr/vulnerability/Linux-kernel-NULL-pointer-dereference-via-vidtv-mux-stop-thread-41123)|An attacker can force a NULL pointer to be dereferenced on the Linux kernel, via |Visit link for details|
