...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |[<a href="https://vigilance.fr/vulnerability/OTRS-Help-Desk-information-disclosure-via-Websocket-Push-Events-41203" class="noirorange"><b>OTRS Help Desk</b>: information disclosure via Websocket Push Events</a>](https://vigilance.fr/vulnerability/OTRS-Help-Desk-information-disclosure-via-Websocket-Push-Events-41203)|An attacker can bypass access restrictions to data of OTRS Help Desk, via Websocket Push Events, in order to read sensitive information...|Visit link for details|
 |[<a href="https://vigilance.fr/vulnerability/Linux-kernel-reuse-after-free-via-nf-tables-Anonymous-Set-41202" class="noirorange"><b>Linux kernel</b>: reuse after free via nf_tables Anonymous Set</a>](https://vigilance.fr/vulnerability/Linux-kernel-reuse-after-free-via-nf-tables-Anonymous-Set-41202)|An attacker can force the reuse of a freed memory area of the Linux kernel, via nf_tables Anonymous Set, in order to trigger a denial of service, and possibly to run code...|Visit link for details|
 |[<a href="https://vigilance.fr/vulnerability/Linux-kernel-memory-corruption-via-io-sqe-buffer-register-41201" class="noirorange"><b>Linux kernel</b>: memory corruption via <wbr>io_sqe_buffer_regist<wbr>er()</wbr></wbr></a>](https://vigilance.fr/vulnerability/Linux-kernel-memory-corruption-via-io-sqe-buffer-register-41201)|An attacker can trigger a memory corruption of the Linux kernel, via |Visit link for details|
