...
# CyberOwl
 ...
 > Last Updated 02/03/2023 09:22:00 UTC
...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |[<a href="https://vigilance.fr/vulnerability/Linux-kernel-memory-corruption-via-pick-next-rt-entity-40680" class="noirorange"><b>Linux kernel</b>: memory corruption via <wbr>pick_next_rt_entity(<wbr>)</wbr></wbr></a>](https://vigilance.fr/vulnerability/Linux-kernel-memory-corruption-via-pick-next-rt-entity-40680)|An attacker can trigger a memory corruption of the Linux kernel, via |Visit link for details|
 ...
 |[<a href="https://vigilance.fr/vulnerability/Linux-kernel-reuse-after-free-via-asus-kbd-backlight-set-40677" class="noirorange"><b>Linux kernel</b>: reuse after free via <wbr>asus_kbd_backlight_s<wbr>et()</wbr></wbr></a>](https://vigilance.fr/vulnerability/Linux-kernel-reuse-after-free-via-asus-kbd-backlight-set-40677)|An attacker can force the reuse of a freed memory area of the Linux kernel, via |Visit link for details|
