...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |[<a href="https://vigilance.fr/vulnerability/Apache-Tomcat-denial-of-service-via-Multipart-Upload-Temporary-48590" class="noirorange"><b>Apache Tomcat</b>: denial of service via Multipart Upload Temporary</a>](https://vigilance.fr/vulnerability/Apache-Tomcat-denial-of-service-via-Multipart-Upload-Temporary-48590)|An attacker can cause a fatal error of Apache Tomcat, via Multipart Upload Temporary, in order to trigger a denial of service...|Visit link for details|
 |[<a href="https://vigilance.fr/vulnerability/Apache-Tomcat-directory-traversal-via-PUT-Rewrite-48589" class="noirorange"><b>Apache Tomcat</b>: directory traversal via PUT Rewrite</a>](https://vigilance.fr/vulnerability/Apache-Tomcat-directory-traversal-via-PUT-Rewrite-48589)|An attacker can traverse directories of Apache Tomcat, via PUT Rewrite, in order to write a file outside the service root path...|Visit link for details|
