...
# CyberOwl
 ...
 > Last Updated 11/12/2025 21:29:26 UTC
...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |[<a href="https://vigilance.fr/vulnerability/FortiOS-memory-corruption-via-HTTP-Format-String-46568" class="noirorange"><b>FortiOS</b>: memory corruption via HTTP Format String</a>](https://vigilance.fr/vulnerability/FortiOS-memory-corruption-via-HTTP-Format-String-46568)|An attacker can trigger a memory corruption of FortiOS, via HTTP Format String, in order to trigger a denial of service, and possibly to run code...|Visit link for details|
