...
# CyberOwl
 ...
 > Last Updated 02/02/2025 09:20:08 UTC
...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |[<a href="https://vigilance.fr/vulnerability/editorconfig-core-c-buffer-overflow-via-Many-Escaped-Characters-45785" class="noirorange"><b>editorconfig-core-c</b>: buffer overflow via Many Escaped Characters</a>](https://vigilance.fr/vulnerability/editorconfig-core-c-buffer-overflow-via-Many-Escaped-Characters-45785)|An attacker can trigger a buffer overflow of editorconfig-core-c, via Many Escaped Characters, in order to trigger a denial of service, and possibly to run code...|Visit link for details|
 |[<a href="https://vigilance.fr/vulnerability/xfpt-buffer-overflow-via-Parameters-45784" class="noirorange"><b>xfpt</b>: buffer overflow via Parameters</a>](https://vigilance.fr/vulnerability/xfpt-buffer-overflow-via-Parameters-45784)|An attacker can trigger a buffer overflow of xfpt, via Parameters, in order to trigger a denial of service, and possibly to run code...|Visit link for details|
