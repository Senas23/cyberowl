...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |[<a href="https://vigilance.fr/vulnerability/Apache-Commons-VFS-directory-traversal-via-FileObject-API-46674" class="noirorange"><b>Apache Commons VFS</b>: directory traversal via FileObject API</a>](https://vigilance.fr/vulnerability/Apache-Commons-VFS-directory-traversal-via-FileObject-API-46674)|An attacker can traverse directories of Apache Commons VFS, via FileObject API, in order to read a file outside the service root path...|Visit link for details|
