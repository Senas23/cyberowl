...
# CyberOwl
 ...
 > Last Updated 15/03/2023 21:18:47 UTC
...
## OBS-Vigilance [:arrow_heading_up:](#cyberowl)
 ...
 |Title|Description|Date|
 |---|---|---|
 |[<a href="https://vigilance.fr/vulnerability/Linux-kernel-NULL-pointer-dereference-via-drivers-gpu-vmxgfx-vmxgfx-execbuf-c-40787" class="noirorange"><b>Linux kernel</b>: NULL pointer dereference via <wbr>drivers/gpu/vmxgfx/v<wbr>mxgfx_execbuf.c</wbr></wbr></a>](https://vigilance.fr/vulnerability/Linux-kernel-NULL-pointer-dereference-via-drivers-gpu-vmxgfx-vmxgfx-execbuf-c-40787)|An attacker can force a NULL pointer to be dereferenced on the Linux kernel, via |Visit link for details|
